...
test.group('Station Configs Controller', (group) => {
    ...
    test('should return default config structure when no configuration exists', async ({ client, assert }) => {
        ...
        const intervalFields = [
            'tempInterval', 'windSendInterval', 'windSampleInterval',
            'diagInterval', 'timeInterval', 'restartInterval',
            'sleepStartHour', 'sleepEndHour', 'otaHour', 'otaMinute', 'otaDuration'
        ]
     ...
     */
    test('should return existing config structure when configuration exists', async ({ client, assert }) => {
        ...
        const expectedFields = [
            'id', 'stationId', 'tempInterval', 'windSendInterval', 'windSampleInterval',
     ...
     */
    test('should return success response structure when storing configuration', async ({ client, assert }) => {
     ...
     */
    test('should return error response structure when API key is missing', async ({ client, assert }) => {
     ...
     */
    test('should return error response structure for invalid data types', async ({ client, assert }) => {
     ...
     */
    test('should return success response structure for OTA confirmation', async ({ client, assert }) => {
     ...
     */
    test('should return error response structure when no config exists for OTA confirmation', async ({ client, assert }) => {
     ...
     */
    test('should reset remote_ota flag to false after OTA confirmation', async ({ client, assert }) => {
