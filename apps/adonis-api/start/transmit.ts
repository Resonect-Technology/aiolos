...
transmit.authorize<{ sensor_id: string }>('wind/live/:sensor_id', async (_ctx: HttpContext, params: { sensor_id: string }) => {
...
transmit.authorize<{ station_id: string }>('station/diagnostics/:station_id', async (_ctx: HttpContext, params: { station_id: string }) => {
...
transmit.authorize<{ sensor_id: string }>('temperature/live/:sensor_id', async (_ctx: HttpContext, params: { sensor_id: string }) => {
    const stationId = params.sensor_id
