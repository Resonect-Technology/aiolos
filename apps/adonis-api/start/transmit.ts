...
transmit.authorize<{ sensor_id: string }>('wind/live/:sensor_id', async (ctx: HttpContext, params: { sensor_id: string }) => {
...
transmit.authorize<{ station_id: string }>('station/diagnostics/:station_id', async (ctx: HttpContext, params: { station_id: string }) => {
