...
export default class extends BaseSchema {
  protected tableName = 'wind_data_hourly'
  ...
  async up() {
    this.schema.createTable(this.tableName, (table) => {
      ...
      table.enu('tendency', ['increasing', 'decreasing', 'stable']).notNullable()
      table.decimal('gust_speed', 8, 2).notNullable()
      table.integer('calm_periods').notNullable()
