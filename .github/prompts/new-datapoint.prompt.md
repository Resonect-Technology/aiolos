...
mode: agent
description:
  Guide for implementing new data points in the Aiolos Weather Station firmware
tools:
  [
    'semantic_search',
    'file_search',
...
Create a complete implementation for a new data point to be collected and
transmitted from the Aiolos Weather Station firmware to the backend server.
