...
mode: agent
description:
  Guide for implementing frontend UI components that consume existing backend
  APIs
tools:
  [
    'semantic_search',
...
Create a React frontend component or feature that consumes an existing API
endpoint from the Aiolos Weather Station backend, displaying the data in an
